...
define(function() {
	...
	MersenneTwister.prototype.integer = function() {
		var y;
	...
	MersenneTwister.prototype.byte = function() {
		return (this.integer() & 0xFF);
	}
	 
	/* generates a random number on [0,1]-real-interval */
	MersenneTwister.prototype.numberOnClosedUnitInterval = function() {
		return this.integer()*(1.0/4294967295.0); 
		/* divided by 2^32-1 */ 
	}
	 
	/* generates a random number on (0,1)-real-interval */
	MersenneTwister.prototype.numberOnOpenUnitInterval = function() {
		return (this.integer() + 0.5)*(1.0/4294967296.0); 
		/* divided by 2^32 */
	}
